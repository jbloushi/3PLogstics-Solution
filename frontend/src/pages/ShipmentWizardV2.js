...
const ShipmentWizardV2 = () => {
    ...
    const handleCarrierChange = (carrierCode) => {
        ...
        const profile = CARRIER_PROFILES[carrierCode] || CARRIER_PROFILES.DGR;
        if (!profile.supportsDangerousGoods) {
            setDangerousGoods({ contains: false, serviceCode: '', unNumber: '', properName: '', class: '', packingGroup: '' });
        }
    };
